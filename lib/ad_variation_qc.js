 ...
 * @returns {Promise<{verdict:string, quality:number, energy:number|null, issues:string[], why:string, action:string}|null>}
 */
export async function qcAdVariation(videoPath) {
  ...
  return { verdict, quality, energy, issues, why, action };
}
