...
Also write a TITLE: a punchy 4-6 word label for THIS specific ad, based on its opening hook / angle (what makes it distinct from other variations of the same offer). Listen to the first few spoken seconds. Title Case, no surrounding quotes, no trailing period. Good examples: Straight-A's, But A 3 · The $40K Tuition Math · Summer Head-Start · Champions In The Off-Season · Two Students, Same Class · The College Board Loophole. Bad (too generic): "Talking Head Ad", "AP Ad", "Variation".
