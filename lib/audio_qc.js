...
export async function runBgmAudioQc(args, opts = {}) {
  ...
  const body = JSON.stringify({
    ...
    generationConfig: {
      ...
      temperature: 0.1,
      // PR-B1: bumped 256 → 8192 to match broll_picker. Same reason as
      // stock_keyword_gen + bgm_select — Gemini-3.1-Pro can consume tokens
      // on internal reasoning even with JSON response mime type set.
