...
// 2026-05-08 audit: bumped from gemini-2.5-flash to gemini-3.1-pro-preview
// per Shannon's "Gemini Pro only on clean-mode AI decisions" directive.
// Bad-take detection is a clean-mode pipeline AI step (chooses what to cut
// from the rendered short), so it falls under the Pro-only rule. See
// lib/slate_detect.js for the same change + rationale + lock-in test.
