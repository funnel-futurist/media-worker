...
HARD RULE: If a candidate is only "kind of related", DO NOT USE IT. Leave that section as talking head instead. Fewer strong picks beat more weak picks.
...
export async function pickBrollInsertions({
  ...
  for (let parseAttempt = 0; parseAttempt < maxParseAttempts; parseAttempt++) {
    ...
    return { ok: true, insertions: kept, rejected, model };
  }
}
