              ...
              for (const kw of stockKeywordsList) {
                ...
                for (const hit of searchResult.hits) {
                  ...
                  try {
                    ...
                    // Tier 2-b: per-asset face-aware crop offset for landscape
                    // stock. Skip portrait/square (height >= width) — naive
                    // center-crop is a no-op there, and skipping avoids
                    // wasting ~1-2s per portrait clip. detectFaceOffsetX is
                    // always-resolves (falls back to 0.5 on any failure), so
                    // composeFaceAndBrolls never breaks here.
