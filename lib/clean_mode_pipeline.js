...
export function buildPipelineOpts(req) {
  return {
    ...
    silenceNoiseDb: typeof req.options?.silenceNoiseDb === 'number' ? req.options.silenceNoiseDb : -35,
    silenceMinDur: typeof req.options?.silenceMinDur === 'number' ? req.options.silenceMinDur : 0.6,
