...
// Vertical spacing between stacked lines as a multiple of font size. Needs
// to clear the 8px stroke + 6px shadow on both sides so descenders of
// line N never tangle with ascenders of line N+1.
const LINE_SPACING_FACTOR = 1.30;
// Vertical anchor for the title block. Dead-centre (0.5) sits the title
// directly over the speaker's torso; biasing to ~0.38×h pulls it into the
// upper-middle so the subject's body and the bottom subtitle zone stay
// clear, while still leaving the top safe margin.
const VERTICAL_CENTER_RATIO = 0.38;
