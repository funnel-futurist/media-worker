 ...
 * — the style Shannon validated visually post-PR-#95: punchy 4-word groups,
 * big bold font, white-on-dark stroke. Position is "just below middle" of
 * the 1920px canvas (PR #99) — modern reel placement, not bottom-documentary.
 *
 ...
 *   - Bottom-center alignment + **MarginV=820** → caption baseline at y≈1100,
 *     just below the 960px vertical midpoint (PR #99 — was MarginV=200)
 *
...
Style: Default,Montserrat,80,&H00FFFFFF,&H000000FF,&H001A1A1A,&H00000000,-1,0,0,0,100,100,1,0,1,4,2,${alignment},40,40,820,1
