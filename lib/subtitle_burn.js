 ...
 *
 * **PR-Y (2026-05-14):** the legacy `opts.introOffsetSec` parameter
 * was removed. PR-L's prepend-and-shift architecture is gone; the new
 * intro hook overlays drawtext on the existing video without any
 * timeline shift. Subtitle words during the intro window are filtered
 * out at the orchestrator level (post-remap) instead. The PR #127
 * cut-overlap-merge fix below is unchanged.
 *
...
export function generateAss(lines, opts = {}) {
  ...
  // Ad caption style: gold/yellow fill (#E4A92A → BGR &H002AA9E4), black
  // outline, lower-third placement. Matches the 1080x1350 ad reference.
  // Reel style (default): white fill, dark outline, upper-chest placement.
  const captionStyle = opts.captionStyle === 'ad'
    ? 'Default,Arial Bold,60,&H002AA9E4,&H000000FF,&H00000000,&H00000000,-1,0,0,0,100,100,1,0,1,4,2'
    : 'Default,Montserrat Black,80,&H00FFFFFF,&H000000FF,&H001A1A1A,&H00000000,-1,0,0,0,100,100,1,0,1,4,2';
...
Style: ${captionStyle},${alignment},40,40,${marginV},1
